...
- (void)createViews
{
    ...
    float cw = self.view.frame.size.width-100;
    
    float ch = (3*cw)/4;
    
    float customHeaderHeight = self.view.frame.size.height - ch;
    ...
    webViewBounds.size.height = ch;//_browserOptions.location ? FOOTER_HEIGHT : TOOLBAR_HEIGHT;
    self.webView = [[UIWebView alloc] initWithFrame:CGRectMake(0, customHeaderHeight-20, self.view.frame.size.width, ch+20)];
    ...
    self.webView.backgroundColor = [UIColor colorWithRed:32/255.0 green:32/255.0 blue:32/255.0 alpha:1];
    ...
    UIView * customHeaderView = [[UIView alloc] initWithFrame:CGRectMake(0, 0, self.view.frame.size.width, customHeaderHeight)];
    customHeaderView.backgroundColor = [UIColor colorWithRed:32/255.0 green:32/255.0 blue:32/255.0 alpha:1];
    [self.view addSubview:customHeaderView];
    
    UIButton * customCloseButton = [UIButton buttonWithType:UIButtonTypeCustom ];
    customCloseButton.frame = CGRectMake(0, 70, 100, 50);
    [customCloseButton addTarget:self action:@selector(close) forControlEvents:UIControlEventTouchUpInside];
    customCloseButton.backgroundColor = [UIColor colorWithRed:120/255.0 green:120/255.0 blue:120/255.0 alpha:0.0];
    if (_browserOptions.toolbar != YES) {
        [self.view addSubview:customCloseButton];
        [self.view bringSubviewToFront:customCloseButton];
    }
    /* ...................Custom Made - Shishir....................*/
...
- (void) setWebViewFrame : (CGRect) frame {
    ...
    [self.webView setFrame:CGRectMake(0, self.view.frame.size.height - (ch+20), self.view.frame.size.width, ch+20)];
    
    
    //    UIView * statusBarbgView = [[UIView alloc] initWithFrame:[[UIApplication sharedApplication] statusBarFrame]];
    //
    //    statusBarbgView.backgroundColor = [[UIColor blackColor] colorWithAlphaComponent:0.3];
    //
