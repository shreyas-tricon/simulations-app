 ...
 - (void)setCookieValue:(CDVInvokedUrlCommand*)command
{
    ...
    NSString* expireInDay = [command.arguments objectAtIndex:3];
    NSInteger expireDay = [expireInDay intValue];
    ...
    [cookieProperties setObject:[[NSDate date] dateByAddingTimeInterval:60*60*expireDay]forKey:NSHTTPCookieExpires];
