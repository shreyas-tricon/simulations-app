/* vim: set noexpandtab: */
var API_SERVER_NAME = "gamma.ck12.org";
var API_SERVER_HOST = "gamma.ck12.org";
window.match_url =  API_SERVER_NAME
var API_SERVER_URL = "gamma.ck12.org";
window.match_url = API_SERVER_NAME;
...
window.reader_configs = {
    ...
    "APP_GA_TRACKER": {
      "ios_tracker": /gamma.ck12.org/i.test(window.match_url)?"UA-5330854-17":"UA-33406409-5",
      "android_tracker": /gamma.ck12.org/i.test(window.match_url)?"UA-5330854-17":"UA-33406409-5"//"UA-78556754-1"
    },
    "brainflex": {
      "goal_per_concept": 1
    },
