cordova.define("cordova-plugin-cookieemperor.cookieEmperor", function(require, exports, module) {
/**
 * CookieEmperor
 * @constructor
 */
 ...
 * @param errorCallback
 */
CookieEmperor.prototype.setCookie = function (url, cookieName, cookieValue, expires, successCallback, errorCallback) {
    cordova.exec(successCallback, errorCallback,  this.pluginName, 'setCookieValue', [url, cookieName, cookieValue, expires]);
};
